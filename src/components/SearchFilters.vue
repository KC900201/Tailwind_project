  ...
  <section class="bg-gray-800 xl:w-72">
    <div class="flex justify-between px-4 py-3 xl:hidden">
      ...
      <button
        ...
        "
        @click="toggle"
        :class="[isOpen ? 'bg-gray-600' : 'bg-gray-700']"
      >
        <svg
    ...
    >
      <div class="lg:flex xl:blockl xl:overflow-y-auto">
        <div
          class="
            px-4
            py-4
            border-t border-y border-gray-900
            lg:w-1/3
            xl:border-t-0 xl:w-full
          "
        >
        ...
        <div
          class="
            ...
            lg:w-1/3 lg:border-l
            xl:w-full
          "
        >
          <!--Continue here https://github.com/adamwathan/workcation/blob/master/src/components/SearchFilters.vue -->
        </div>
        <div
          class="
            px-4
